...
docs/                # methodology, dsl-reference (índice), dsl/<capa>.md, building-a-generator,
                     ...
                     # (+ <servicio>/origin/: documentación del diseño del registry del que se derivó,
                     #    congelada y solo de referencia — no es un derivado de este servicio)
