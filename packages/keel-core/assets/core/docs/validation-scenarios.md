...
- **Concurrencia.** Si el diseño contempla actualizaciones concurrentes, un escenario ejercita dos mutaciones sobre la misma entidad y fija el resultado esperado (conflicto declarado vs último gana).
