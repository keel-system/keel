...
└── infrastructure/      # adaptadores — habla con el mundo exterior
    ...
    ├── http/            # (solo con capa http-clients) clientes RestClient + resilience4j
