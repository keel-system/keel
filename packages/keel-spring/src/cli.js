...
program
  .command('build')
  .description('Instala la skill keel-generate-spring, valida el servicio y genera el scaffolding determinista; la lógica de negocio la completa el agente')
