...
program
  .command('build')
  .description('Valida el servicio, pregunta el stack y genera en services/<servicio>-spring/ el scaffolding transversal al stack más el .claude/ del agente; los adaptadores de infraestructura y la lógica de negocio se completan después con /keel-generate-spring dentro del proyecto')
